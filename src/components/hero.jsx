...
const Hero = () => {
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-12 ml-20`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-[#26281E] ss:leading-[100.8px] leading-[75px]">
            A Hackathon <br className="sm:block hidden" />{" "}
            <span className="text-gradient">FastHacks</span>{" "}
          </h1>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={robot} alt="billing" className="w-[60%] h-[100%] relative z-[5]" />
        {/* 
