...
Hackathon</h3>
        ...
        <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
          ...
          <div className="order-1 bg-[#A5A58D] rounded-lg shadow-xl w-5/12 px-6 py-4">
          <h3 className="mb-3 font-bold text-gray-800 text-xl font-poppins">Demo Day</h3>
            <p className="leading-snug tracking-wide text-gray-900 text-[18px] text-opacity-100  font-poppins">15th of April</p>
          </div>
        </div>
        ...
        <div className="mb-8 flex justify-between items-center w-full right-timeline">
          ...
          <div className="order-1 bg-[#A5A58D] rounded-lg shadow-xl w-5/12 px-6 py-4">
            <h3 className="mb-3 font-bold text-gray-800 text-xl  font-poppins">Announce Winners</h3>
            <p className="leading-snug tracking-wide text-gray-900 text-[18px] text-opacity-100  font-poppins">16th of April</p>
          </div>
        </div>
      </div>
    </div>
